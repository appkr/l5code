...
class PasswordsController extends Controller
{
    ...
    public function postRemind(Request $request)
    {
        ...
        return $this->respondSuccess(trans('auth.passwords.sent_reminder'));
    }
    ...
    public function postReset(Request $request)
    {
        ...
        if (! \DB::table('password_resets')->whereToken($token)->first()) {
            return $this->respondError(trans('auth.passwords.error_wrong_url'));
        }

        \DB::table('password_resets')->whereToken($token)->delete();

        return $this->respondSuccess(trans('auth.passwords.success_reset'));
    }
